# Generated by Django 4.2.11 on 2024-03-12 12:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first_app.carowner')),
            ],
        ),
        migrations.CreateModel(
            name='DrivingLicense',
        ...
        migrations.AddField(
            model_name='carowner',
            name='cars',
            field=models.ManyToManyField(through='first_app.Ownership', to='first_app.car'),
        ),
    ]
